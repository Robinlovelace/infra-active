...
The techniques developed in this paper require relatively low time and financial resources, relative to the costs of major infrastructure projects such as new roads and railways, which can reach many billions of dollars and take decades to complete.
Considering these resource implications, and the fact that impact assessments are generally more effective when undertaken early in the planning process, we believe the approach will be of most use when undertaken at scheme inception and scoping.
