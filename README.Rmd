...
Recently other types of assessment have emerged, including health and equality impact assessment [@harris-roxas_differing_2011].
There is an emerging literature focussing explicitly on active travel impacts, much of which seeks to evaluate the impacts of new schemes on walking [@mueller_health_2015].
...
In some cases, environmental arguments have been made for investment in transport infrastructure, despite the finding that increased transport connectivity tends to increase demand [@akerman_role_2011].
In practice other justifications, including social mobility and economic growth, are the deciding factor, however [@flyvbjerg_policy_2005].
