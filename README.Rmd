...
l_seg = lewes_uckfield %>% as(., "Spatial") %>% 
  line_segment(lewes_uckfield, segment_length = 1000) %>% 
  st_as_sf(.)
...
# res_stations = readRDS("../pct-team/input-data/res_stns.Rds")
# write_csv(res_stations, "res_stns.csv")
res_stations = read_csv("res_stns.csv")
