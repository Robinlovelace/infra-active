...
The number of people who are affected by these scenarios will depend on the type of infrastructure, its design, and the nature of the surrounding area. By analysing parallels, the method can aid in understanding if an active travel route would be useful alongside on some or all of the new linear infrastructure.
Crucially, it not only accounts for existing active transport trips but the potential to generate new ones.
