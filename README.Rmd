...
<!-- [@harris-roxas_differing_2011]. --> There is an emerging literature focussing explicitly on active travel impacts, much of which seeks to evaluate the impacts of new schemes on walking.
...
It is based on the division of active travel impacts based on the geographic relations between the development and walking and cycling desire lines: *Severance*, when new infrastructure cuts across routes with high active travel potential; *parallels*, opportunities for constructing active travel features parallel to new infrastructure; and *integration* with existing transport services, where new or different active travel options are unlocked by new infrastructure.
...
Nearly 12000 kilometres of high speed rail were under construction in 2020, representing a 25% increase in total high speed route length.

Meanwhile, the pressure on authorities to consider how such projects impact on sustainability continues to grow.
In most of the developed world, transport is now the largest source of greenhouse gas emissions, and as new emission reduction targets are set on a national and pan-national level, the types of infrastructure being prioritised may change as the need to shift towards more sustainable modes of moving people and goods across land becomes more critical.
...
Active travel is mentioned in heading, but only as a sub-sub-heading within road safety: "Active travel and (mis)perceptions of danger".
...
Such new parallel footways and cycleways could encourage people to entirely replace existing trips by non-active modes.
