...
We find that commonly available geographic datasets representing desire lines between the proposed/planned/new development, and the centreline of the proposed new linear infrastructure, can generate actionable evidence on a range of active travel impacts.
This evidence can be generated rapidly and at relatively low cost to influence planning decisions and rank route options during project scoping stages.
During planning, construction and post-build stages the methods could be used to prioritise investments in crossings and other interventions to mitigate negative scheme impacts and maximise benefits, e.g. by encouraging access to new rail stations and bus stops on the new route by active modes to reduce car dependency.
...
The Go Dutch and Ebike scenarios assume that English commuters acquire a Dutch cycling culture and Dutch levels of infrastructure: A high quality, traffic-free cycle route along the Lewes-Uckfield train line could be a helpful step towards achieving Dutch infrastructure.
However, it should be remembered that the impact of the cycle path might also depend on the quality of the surrounding cycle network.
