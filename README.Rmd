...
author: "Robin Lovelace, Malcolm Morgan, Craig Morton, Gareth Dennis, Dina Jankovic"
date: "`r Sys.Date()`"
# output: md_document
output:
...
Major transport infrastructure projects affect every aspect of life, from health and the economy to the environment.
Such impacts can be formally accounted for in the planning process using established processes, including economic appraisal, cost-benefit analysis and environmental impact assessment.
More recently, other types of assessment have emerged, including Health Impact Assessment (HIA) and equality impact assessment (EqIA) .
<!-- [@harris-roxas_differing_2011]. -->
<!-- Recent research has explicitly focussed on active travel impacts, much of which seeks to evaluate the impacts of new schemes on walking. -->
<!-- [@mueller_health_2015]. -->
However, there has to date been little in the way of research into or applications of methods for evaluating the impacts of major infrastructure projects on walking and cycling.
This paper paper sets out to help fill this gap in scheme appraisal by developing new methods for Active Travel Impact Assessment (ATIA).
In the context of climate and obesity crises, it is particularly important to take these impacts into account *before* new infrastructure schemes are approved.
Before, during and after the construction phase, evidence from ATIA can also be used to mitigate impacts, for example by highlighting places where new crossings could reduce severance.
The ATIA methodology proposed in this paper is based on the following classification of active travel impacts: *severance*, when new infrastructure cuts across routes with high active travel potential; *parallels*, opportunities for constructing active travel features parallel to new infrastructure; *integration* with existing transport services, where new or different active travel options are unlocked by new infrastructure; and impacts that arise during the *construction* phase of major infrastructure projects.
The input datasets are 1) origin-destination data representing travel in the local area, which can obtained from secondary data sources, surveys or simulations; and 2) the centreline of proposed infrastructure.
The methods have relatively low time and cost requirements, enabling their use throughout the planning process.
The approach can be used to support: assessment of scheme sustainability, ranking of route options, prioritisation of safe routes to public transport nodes alongside the proposed scheme, and investment in crossing points.
A case study of a proposed railway between Lewes and Uckfield in Essex, UK, demonstrates the methods' real-world application and potential.
We conclude that the approach has great potential to assess the active travel impacts of proposed infrastructure, including high speed rail projects.
...
The costs and benefits of such schemes are contested and subject to uncertainty [@salling_2009_assessment].

Meanwhile, the pressure on authorities to consider how such projects impact sustainability objectives continues to grow.
In much of the developed world, motorised transport is now the largest sector of the economy by greenhouse gas emissions, and a major cause of health inequalities arising from environments that cause injury and death through collisions and inactive lifestyles associated with non-communicable diseases. 
As new emission reduction and active travel targets are set on regional, national and international levels, the types of infrastructure being prioritised will change.
<!-- as the need to shift towards more sustainable modes of moving people and goods across land becomes more urgent and widely understood. -->
...
piggyback::pb_download("l_seg.Rds")
...
Overall, Table 1 suggests that the potential for cycling along routes parallel to the track appears to be somewhat greater than the cycling potential of 'severed' routes.
...
Another key results is that there is substantial potential for integration between cycling and public transport in the study area.
...
This paper has articulated the concept of Active Travel Impact Assessment (ATIA) and demonstrated the potential for geographic methods to assess the impacts of major infrastructure projects on walking and cycling at all stages in the planning process.
The methods presented have relatively low time and financial resource requirements, compared with overall impact assessment evaluation work, including Environmental Impact Assessment (IEA).
The costs of major infrastructure projects such as new roads and railways can reach many billions of dollars and take decades to complete; any changes to schemes to minimise active travel impacts --- or the cancellation of schemes altogether in light of evidence suggesting that active travel costs outweigh journey time and emissions benefits --- could save millions each year, meaning that the process of ATIA could have very high benefit cost ratios.
Considering these resource implications, and the fact that impact assessments are generally more effective when undertaken early in the planning process, we believe the approach will be of most use when undertaken earlier in the planning process, and at scheme inception and scoping in particular.
If undertaken sufficiently early in the planning process, methods for ATIA could change the outcome of planning decisions, including whether or not a project goes ahead: if negative active travel impacts are large relative to time and other savings, proposed new infrastructure should be questioned.

A real world case study was used to demonstrate how the methods can be applied in practice and the kind of results they can generate.
It was found that there was greater potential for cycling uptake parallel to the proposed route than perpendicular to it, indicating the risks of community severance for cycling uptake are likely to be lower than the potential for cycling uptake along lines parallel to the route, assuming high quality cycling infrastructure is built alongside the new rail route.

The case study shows that the methods can generate quantitative and reproducible estimates of impact: we estimate that around 2500 commuters make trips that are parallel to the line, of whom 1.1% currently cycle (N=28).
We further estimate that scenaios of cycling uptake, the proportion of these commuter cycling would increase, to around 6% (N=158).
A high quality, traffic-free cycle route along the Lewes-Uckfield train line could be a useful step towards realising this aim of boosting cycling levels in the area, although it should be remembered that the impact of the cycle path might also depend on the quality of the surrounding cycle network.
...
Thanks to Shane Snow, Active Travel Sponsor, High Speed & Major Rail Projects, Department for Transport, for commissioning this project and providing maps of the Lewes-Uckfield route.
