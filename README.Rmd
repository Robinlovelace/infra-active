...
Recently other types of assessment have emerged, including health and equality impact assessment.
...
EIA, for example, often includes a substantial health component and health is enshrined in the European Union Directive 2014/52/EU in impact assessment [@_directive_2014].
...
The majority of desire lines intersecting the buffer are between Brighton (the largest city in the region - see the high density of flows in the far south-west of Figure \@ref(fig:lc)) and its surrounding settlements.
